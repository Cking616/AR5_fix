...
#define OVER_CURRENT_THRESHOLD 50.0f
#else
#if ZZ_MOTOR == 1
...
#define S_CURVE_MAX_SPEED 180.0f * HARMONIC_AMPLIFY
#define S_CURVE_MAX_ACCELERATION 360.0f * HARMONIC_AMPLIFY
#define S_CURVE_JERK 360.0f * HARMONIC_AMPLIFY
#define S_CURVE_SPEED_RESOLUTION 6.0f

#if BIG_ID_ENABLE == 1
#define BRAKE_CONTROL_ANGLE 360.0f / 12.0f / HARMONIC_AMPLIFY
#else
#define BRAKE_CONTROL_ANGLE 360.0f / 8.0f / HARMONIC_AMPLIFY
#endif
