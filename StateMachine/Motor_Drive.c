	...
	switch(gsM1_Drive.sInitLocating.u8LocatingStep)
	{
		...
		case 8: 
			...
			gsM1_Drive.sInitLocating.f32Theta_Offset = (gsM1_Drive.sInitLocating.s32TurnsMech*ENCODER_PPR*4.0f + gsM1_Drive.sInitLocating.f32PositionMech - \
																								 gsM1_Drive.sInitLocating.s32TurnsMechPre*ENCODER_PPR*4.0f - gsM1_Drive.sInitLocating.f32PositionMechPre)/ENCODER_PPR/4.0f*2.0f*PI*POLE_PAIR_NUM;
		...
		case 10: 
	      ...
	      Motor_Drive_FOC();
			...
			if(TB_delay_IsElapsed())
			{
				...
				gsM1_Drive.sInitLocating.f32Theta_Offset = (gsM1_Drive.sInitLocating.s32TurnsMech*ENCODER_PPR*4.0f + gsM1_Drive.sInitLocating.f32PositionMech - \
																									 gsM1_Drive.sInitLocating.s32TurnsMechPre*ENCODER_PPR*4.0f - gsM1_Drive.sInitLocating.f32PositionMechPre)/ENCODER_PPR/4.0f*2.0f*PI;
