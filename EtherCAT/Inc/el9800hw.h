...
//-----------------------------------------------------------------------------------------------------
#define SWITCH_1            PCin(13)				// PORTDbits.RD7 /**< \brief Access to switch 1 input*/
#define SWITCH_2            PCin(14)				// PORTDbits.RD6 /**< \brief Access to switch 2 input*/
#define SWITCH_3            PCin(15)				// PORTDbits.RD5 /**< \brief Access to switch 3 input*/
#define SWITCH_4            PFin(4)				// PORTDbits.RD4 /**< \brief Access to switch 4 input*/
#define SWITCH_5            PFin(5)				// PORTDbits.RD3 /**< \brief Access to switch 5 input*/
#define SWITCH_6            PFin(6)				// PORTDbits.RD2 /**< \brief Access to switch 6 input*/
#define SWITCH_7            PFin(7)				// PORTDbits.RD1 /**< \brief Access to switch 7 input*/
#define SWITCH_8            PFin(8)				// PORTDbits.RD0 /**< \brief Access to switch 8 input*/

#define LED_1                 PGout(11)				// LATBbits.LATB8 /**< \brief Access to led 1 output*/
...
#define LED_4                 PGout(8)				//LATBbits.LATB11 /**< \brief Access to led 4 output*/
#define LED_5                 PBout(2)				// LATBbits.LATB12 /**< \brief Access to led 5 output*/
#define LED_6                 PFout(12)				// LATBbits.LATB13 /**< \brief Access to led 6 output*/
#define LED_7                 PFout(14)				//LATBbits.LATB14 /**< \brief Access to led 7 output*/
#define LED_8                 PGout(0)
...
#define    DISABLE_ESC_INT()             NVIC_DisableIRQ(EXTI15_10_IRQn)	// {(_INT1IE)=0;} /**< \brief Disable interrupt source INT1*/
#endif
#ifndef ENABLE_ESC_INT
#define    ENABLE_ESC_INT()            NVIC_EnableIRQ(EXTI15_10_IRQn)			// {(_INT1IE)=1;} /**< \brief Enable interrupt source INT1*/
#endif

#ifndef HW_GetTimer
#define HW_GetTimer()       		TIM5->CNT		//(SysTick->LOAD - 	SysTick->VAL) //			// ((UINT16)(TMR7)) /**< \brief Access to the hardware timer*/
#endif

#ifndef HW_ClearTimer
#define HW_ClearTimer()         ((TIM5->CNT)=0); //(SysTick->VAL = SysTick->LOAD)// //{(TMR7) = 0;} /**< \brief Clear the hardware timer*/
#endif
