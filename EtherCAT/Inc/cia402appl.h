...
#define CSVP_MODULE_ID          0x00419800
...
/** \brief 0x1603 (csp RxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
   UINT32   aEntries[6]; /**< \brief Entry buffer*/
...
/** \brief 0x1A03 (csp/csv TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
   UINT32   aEntries[7]; /**< \brief Entry buffer*/
...
typedef struct OBJ_STRUCT_PACKED_START
{
	...
	INT16 objTorqueOffset; /**< \brief Target Offset (0x60B2)*/
...
/**
* \brief Object 0x1603 (csp/csv RxPDO) entry descriptions
 */
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1603[] = "CSVP RxPDO\000\377";
...
/**
 * \brief Object 0x1A03 (csp/csv TxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A03 (csp/csv TxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1A03[] = "csp/csv TxPDO\000\377";
...
/** \brief Object 0x6040 (Control Word) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x60B2 = {DEFTYPE_UNSIGNED16, 0x10, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};
...
= {
/*ECATCHANGE_START(V5.11) CiA402 1*/
{6, {0x60400010,0x607A0020,0x60FF0020,0x60B20010,0x60600008,0x00000008}},    /* TOBJ1600*///控制字 目标位置 目标速度 模式设定 偏移转矩
/*ECATCHANGE_END(V5.11) CiA402 1*/
...
/*ECATCHANGE_START(V5.11) CiA402 1*/
{7, {0x60410010,0x60640020,0x606C0020,0x20B60020,0x60770010,0x60610008,0x00000008}}, /*TOBJ1A00*///当前状态 当前位置 当前速度 模式显示 外部位置 当前转矩
/*ECATCHANGE_END(V5.11) CiA402 1*/
{2, {0x60410010,0x60640020}}, /*TOBJ1A01*/
{2, {0x60410010,0x60640020}},/*TOBJ1A02*/
{7, {0x60410010,0x60640020,0x606C0020,0x20B60020,0x60770010,0x60610008,0x00000008}}, /*TOBJ1A03*/
...
0x0,/*(UINT16) Torque Offset 0x60B2*/
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
   ...
   {NULL,NULL, 0x1602, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1602, aName0x1602, NULL, NULL, NULL, 0x0000 },
	 /* Object 0x1603 */
    {NULL,NULL, 0x1603, {DEFTYPE_PDOMAPPING, 6 | (OBJCODE_REC << 8)}, asEntryDesc0x1603, aName0x1603, NULL, NULL, NULL, 0x0000 },
/*ECATCHANGE_START(V5.11) CiA402 1*/
   /* Object 0x1A00 */
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
   ...
   {NULL,NULL, 0x1A02, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1A02, aName0x1A02, NULL, NULL, NULL, 0x0000 },
	 /* Object 0x1A03 */
   {NULL,NULL, 0x1A03, {DEFTYPE_PDOMAPPING, 7 | (OBJCODE_REC << 8)}, asEntryDesc0x1A03, aName0x1A03, NULL, NULL, NULL, 0x0000 },
   /* Object 0x603F */
